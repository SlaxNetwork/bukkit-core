 ...
 * @version 1.2.1
 */
public class FastBoardImpl implements FastBoard {
     ...
     */
    public void updateTitleStr(String title) {
     ...
     */
    public synchronized void updateLineStr(int line, String text) {
     ...
     * @throws IllegalStateException    if {@link #delete()} was call before
     */
    public void updateLinesStr(String... lines) {
        updateLinesStr(Arrays.asList(lines));
    }
     ...
     * @throws IllegalStateException    if {@link #delete()} was call before
     */
    public synchronized void updateLinesStr(Collection<String> lines) {
     ...
     * After this, all uses of {@link #updateLinesStr} and {@link #updateTitleStr} will throws an {@link IllegalStateException}
     *
    ...
    @Override
    public void updateTitle(@NotNull BoardComponent title) {
        updateTitleStr(serializer.serialize(mm.deserialize(title.getText(), title.getResolvers())));
    }
    ...
    @Override
    public void updateLines(@NotNull BoardLine... lines) {
        updateLines(List.of(lines));
    }
